...
const EmailSection = () => {
  ...
  return (
    ...
    >
      ...
      <div>
        {emailSubmitted ? (
          <p className="text-orange-500 text-sm mt-2">Email sent successfully!</p>
        ) : (
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input
                ...
                id="email"
                required
                className="bg-[#18191E] border border-[#553022] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
